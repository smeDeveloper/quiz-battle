...
import { Github, InstagramIcon, Linkedin, Mail, WifiOff } from 'lucide-react';
  ...
  return (
    <>
      <LoaderContextProvider value={{ isLoading, setIsLoading }}>
        <PopUpContextProvider value={{ setMessageContent }}>
                      ...
                      <footer>
                        <div className="footer-container">
                          ...
                          <div className="footer-right">
                            <a text="LinkedIn" className="linkedin" href="YOUR_LINKEDIN_URL" target="_blank"><Linkedin /></a>
                            <a text="Instagram" className="instagram" href="YOUR_INSTAGRAM_URL" target="_blank"><InstagramIcon /></a>
                            <a text="Github" href="YOUR_GITHUB_URL" target="_blank"><Github /></a>
